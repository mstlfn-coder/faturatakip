...
- Git deposu hazır, ancak uygulama kodu henüz oluşturulmadı.
...
Sıradaki geliştirme fazı `v0.1 - Proje İskeleti ve Veritabanı`.

Bu fazda yalnızca C# WPF proje iskeleti, SQLite altyapısı, temel klasör yapısı, başlangıç migration mantığı ve boş dashboard hazırlanacak. Fatura türü, abonelik, fatura, ödeme, PDF evrak ve rapor ekranları bu fazda yapılmayacak.
