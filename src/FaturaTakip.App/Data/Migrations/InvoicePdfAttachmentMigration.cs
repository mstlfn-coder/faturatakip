...
public sealed class InvoicePdfAttachmentMigration : IDatabaseMigration
{
    public string Id => "0005";

    public string Name => "Add invoice PDF attachment metadata";
    ...
    public void Up(SqliteConnection connection, SqliteTransaction transaction)
    {
        ...
        command.CommandText = """
            CREATE INDEX IF NOT EXISTS ix_invoices_pdf_sha256_hash
                ON invoices (pdf_sha256_hash);
            """;
