...
- Boylece baslik, baglam ipucu ve ilk form alani daha tek parca bir giris akisi kurdu.
- Kucuk duzenleme, sag panelin ust ritmini bozmadan daha toplu hissettirdi.
- Smoke test olarak build ve self-test temiz gecti.
...
- Boylece uzun baglam metinleri baslik alaninda daha duzenli okunur hale geldi.
- Kucuk duzenleme, sag panelin ust kismindaki giris ritmini daha temiz hissettirdi.
- Smoke test olarak build ve self-test temiz gecti.
...
- Boylece durum mesaji ve kaydet dugmesi ustteki form kolonuyla daha dengeli hizalanir hale geldi.
- Kucuk duzenleme, footer kapanisini bozmadan yatay ritmi toparladi.
- Smoke test olarak build ve self-test temiz gecti.
...
- Boylece odak hali hala okunur ama rol olarak daha ikincil hissettiriyor.
- Mikro ayar, odak geri bildirimini kaybetmeden hiyerarsiyi daha dogru kurdu.
- Smoke test olarak build ve self-test temiz gecti.
...
- Boylece yardim metni ile reset dugmesi arasindaki ton farki daha rafine hale geldi.
- Dugme hala okunur ve tiklanabilir hissedilir kalirken satirin geri kalanina daha sakin baglaniyor.
- Smoke test olarak build ve self-test temiz gecti.

## Son Guncelleme (2026-06-16 / v1.219)

- v1.219 tamamlandi: `Hepsini Goster` dugmesinin arka plan tonu yardim satirinin genel sakinligine biraz daha yaklastirildi.
- Boylece yardim metni ile reset dugmesi arasindaki ton gecisi daha yumusak hale geldi.
- Dugme yuzeyi rafine bir sekilde hafifletildi ama aksiyon okunurlugu korunuyor.
- Smoke test olarak build ve self-test temiz gecti.
...
- Boylece yardim metni ile reset dugmesi arasindaki renk gecisi daha yumusak okunuyor.
- Komut hiyerarsisi korunurken satir ici ton farki daha rafine hale geldi.
- Smoke test olarak build ve self-test temiz gecti.
...
- Rozetler uygulanan filtreyi ve gorunen kayit sayisini tek satirda ozetliyor.
- Filtre degisikliginde rozet sayisi listeyle birlikte yenileniyor.
- Smoke test olarak build ve self-test temiz gecti.
...
- Boylece liste satirlari daha canli tepki veriyor ve dogrudan acis davranisi daha belirgin hale geliyor.
- Bu adim odemeler yuzeyinin fare ile taranabilirligini bir kademe daha guclendirdi.
- Smoke test olarak build ve self-test temiz gecti.
...
- Boylece kartlar hareket hissini korurken gorunur vurgu bir kademe daha sakin hale geldi.
- Bu adim hover kartlarinin panel icindeki isik agirligini daha dengeli tuttu.
- Smoke test olarak build ve self-test temiz gecti.
...
- Boylece panel hareketli geri bildirimi korurken, genel gorunum daha sakin ve daha istikrarli hissediliyor.
- Bu adim kartlarin hareket tonunu bir kademe daha olgunlastirdi.
- Smoke test olarak build ve self-test temiz gecti.
...
- Boylece kartlar artik eylem sonucunu ve klavye ile tetikleme ipucunu ayni yerde topluyor.
- Bu adim klavye odakli kullanim icin paneli biraz daha kendi kendini anlatan hale getirdi.
- Smoke test olarak build ve self-test temiz gecti.
